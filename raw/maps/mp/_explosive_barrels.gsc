main()
{
	...
	//SOUND DEFINITIONS
	//-----------------
		level._barrelExpSound = "explo_metal_rand";
	//-----------------
	//-----------------
...
explodable_barrel_explode()
{
	...
	self playsound (level._barrelExpSound);
...
getstruct(name, type)
{
	if(!isdefined(level._struct_class_names))
		return undefined;
...
breakable_clip()
{
	...
	if (isdefined (self.remove))
		level._breakables_clip = common_scripts\utility::array_remove ( level._breakables_clip , self.remove );
}
